...
okport=JOptionPane.showConfirmDialog(null,jp2,"Please enter New port number:",JOptionPane.PLAIN_MESSAGE);
if(okport==JOptionPane.OK_OPTION)
{
    String port1=new String(jp2.getPassword());
    JOptionPane.showMessageDialog(null,port1);
